...
class OpenAICaller:
    ...
    def __init__(self):
        ...
        self.VALID_CHATGPT_MODELS = ['chatgpt', 'chatgpt-16k']#, 'gpt4', 'chatgpt-16k', 'gpt4-32k', 'gpt4-1106']
    ...
    def set_openai_keys(self, openai_config_file='/home/tejas/data/openai_config.yaml'):
        '''
        Set API keys
        '''
